...
local Clicker = params.ClickerEntity
local Players = params.PlayerParticipate

local packet = Players

PackageHandlers:SendToClient(player, "PlayerParticipate", packet)